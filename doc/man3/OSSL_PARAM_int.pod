...
=for openssl generic
 ...
 #define OSSL_PARAM_is_empty(params)
...
OSSL_PARAM_is_empty() is a macro that returns 1 if the I<params> array is either
NULL or contains only a terminating L<OSSL_PARAM(3)> structure.
...
OSSL_PARAM_is_empty() returns 1 if I<params> is empty or 0 otherwise.
...
The macro OSSL_PARAM_is_empty() was added in OpenSSL 3.5.
